        ...
        where Inc1 : struct
    {
        ...
        public override void OnAddEntity(in EcsEntity entity)
        {
            ...
            if (Entities.Length == EntitiesCount)
            {
                ...
                if (_allow1)
                {
                    Array.Resize(ref _get1, newSize);
                }
            }
        ...
        where Inc2 : struct
    {
        ...
        public override void OnAddEntity(in EcsEntity entity)
        {
            ...
            if (Entities.Length == EntitiesCount)
            {
                ...
                if (_allow2)
                {
                    Array.Resize(ref _get2, newSize);
                }
            }
        ...
        where Inc3 : struct
    {
        ...
        public override void OnAddEntity(in EcsEntity entity)
        {
            ...
            if (Entities.Length == EntitiesCount)
            {
                ...
                if (_allow3)
                {
                    Array.Resize(ref _get3, newSize);
                }
            }
        ...
        where Inc4 : struct
    {
        ...
        public override void OnAddEntity(in EcsEntity entity)
        {
            ...
            if (Entities.Length == EntitiesCount)
            {
                ...
                if (_allow4)
                {
                    Array.Resize(ref _get4, newSize);
                }
            }
        ...
        where Inc5 : struct
    {
        ...
        public override void OnAddEntity(in EcsEntity entity)
        {
            ...
            if (Entities.Length == EntitiesCount)
            {
                ...
                if (_allow5)
                {
                    Array.Resize(ref _get5, newSize);
                }
            }
        ...
        where Inc6 : struct
    {
        ...
        public override void OnAddEntity(in EcsEntity entity)
        {
            ...
            if (Entities.Length == EntitiesCount)
            {
                ...
                if (_allow6)
                {
                    Array.Resize(ref _get6, newSize);
                }
            }
